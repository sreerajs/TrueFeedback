...
{
  public function __construct($user_name,$email_sub_title,$email_main_title,$email_text,$email_button_link,$email_button_text) {
  ...
  public function GenerateEmailTemplate() {
    ...
    <title>TrueFeedback Email Template</title><!-- Responsive Styles and Valid Styles -->
    ...
    <!-- ======= logo ======= -->
    <td align="center">
    <a href="" style="display: block; border-style: none !important; border: 0 !important;" class="edit_img"><img editable="true" mc:edit="logo" width="60" border="0" style="display: block;" src="https://bytacoin.telrpay.com/img/email_bytacoin_icon_w.png" alt=""></a>
    </td>
    </tr>
    </tbody></table>
    </td>
    ...
    If you have any queries, then please reply to this email or contact us at <span style="color: #914297;">support@truefeedback.io</span>
    </multiline>
    </div>
    </td>
    </tr>
    ...
    <tr class="tata">
    <td align="center">
    <img src="https://bytacoin.telrpay.com/img/logo.png" alt="Bytacoin" title="TrueFeedback" width="100"/>
    </td>
    </tr>
    <tr class="tata"><td height="20" style="font-size: 20px; line-height: 20px;">&nbsp;</td></tr>
    ...
    <!-- ======= section text ======= -->
    <multiline spellcheck="false" style="display: inline-block; pointer-events: visible;">
    Copyright &copy; truefeedback.io. All rights reserved. To ensure delivery to your inbox, add accounts@truefeedback.io to your address book.<br />
    You are receiving this email because you have registered with TrueFeedback<span>.</span>io and part of our growing audience network.
    </multiline>
    </div>
    </td>
    </tr></div>
