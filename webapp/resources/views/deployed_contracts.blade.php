        ...
        <div class="col-12">
          <div class="c-table-responsive@wide">
            <table class="c-table">
              ...
              <tbody>
                <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}"> @foreach ($dataArray['contractList'] as $contract)
                  ...
                  <td class="c-table__cell">
                    <div class="c-dropdown dropdown">
                      <a href="#" class="c-btn c-btn--info has-icon dropdown-toggle" id="dropdownMenuTable1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Options <i class="feather icon-chevron-down"></i>
                                        </a>

                      <div class="c-dropdown__menu dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuTable1">
                        <!--<a class="c-dropdown__item dropdown-item" onclick="deployContract({{$contract->id}})">Deploy</a>-->
                        <a class="c-dropdown__item dropdown-item" onclick="#">View Stats</a>
                        <a class="c-dropdown__item dropdown-item" onclick="#">Conclude Survey</a>
